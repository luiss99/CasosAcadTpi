...
public class TipoRequisitoJpaController implements Serializable {
    ...
    public void create(TipoRequisito tipoRequisito) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Requisito requisitoListRequisitoToAttach : tipoRequisito.getRequisitoList()) {
                requisitoListRequisitoToAttach = em.getReference(requisitoListRequisitoToAttach.getClass(), requisitoListRequisitoToAttach.getRequisitoPK());
            ...
            for (Requisito requisitoListRequisito : tipoRequisito.getRequisitoList()) {
                TipoRequisito oldTipoRequisitoOfRequisitoListRequisito = requisitoListRequisito.getTipoRequisito();
                requisitoListRequisito.setTipoRequisito(tipoRequisito);
                requisitoListRequisito = em.merge(requisitoListRequisito);
                if (oldTipoRequisitoOfRequisitoListRequisito != null) {
                    oldTipoRequisitoOfRequisitoListRequisito.getRequisitoList().remove(requisitoListRequisito);
                    oldTipoRequisitoOfRequisitoListRequisito = em.merge(oldTipoRequisitoOfRequisitoListRequisito);
                }
            }
            em.getTransaction().commit();
        } catch (Exception ex) {
            if (findTipoRequisito(tipoRequisito.getIdTipoRequisito()) != null) {
    ...
    public void edit(TipoRequisito tipoRequisito) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            TipoRequisito persistentTipoRequisito = em.find(TipoRequisito.class, tipoRequisito.getIdTipoRequisito());
            ...
            for (Requisito requisitoListOldRequisito : requisitoListOld) {
                if (!requisitoListNew.contains(requisitoListOldRequisito)) {
                    ...
                    illegalOrphanMessages.add("You must retain Requisito " + requisitoListOldRequisito + " since its tipoRequisito field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Requisito requisitoListNewRequisitoToAttach : requisitoListNew) {
                requisitoListNewRequisitoToAttach = em.getReference(requisitoListNewRequisitoToAttach.getClass(), requisitoListNewRequisitoToAttach.getRequisitoPK());
            ...
            for (Requisito requisitoListNewRequisito : requisitoListNew) {
                if (!requisitoListOld.contains(requisitoListNewRequisito)) {
                    TipoRequisito oldTipoRequisitoOfRequisitoListNewRequisito = requisitoListNewRequisito.getTipoRequisito();
                    requisitoListNewRequisito.setTipoRequisito(tipoRequisito);
                    requisitoListNewRequisito = em.merge(requisitoListNewRequisito);
                    if (oldTipoRequisitoOfRequisitoListNewRequisito != null && !oldTipoRequisitoOfRequisitoListNewRequisito.equals(tipoRequisito)) {
                        oldTipoRequisitoOfRequisitoListNewRequisito.getRequisitoList().remove(requisitoListNewRequisito);
                        oldTipoRequisitoOfRequisitoListNewRequisito = em.merge(oldTipoRequisitoOfRequisitoListNewRequisito);
                    }
                }
            }
            em.getTransaction().commit();
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = tipoRequisito.getIdTipoRequisito();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                tipoRequisito.getIdTipoRequisito();
            ...
            for (Requisito requisitoListOrphanCheckRequisito : requisitoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This TipoRequisito (" + tipoRequisito + ") cannot be destroyed since the Requisito " + requisitoListOrphanCheckRequisito + " in its requisitoList field has a non-nullable tipoRequisito field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
    ...
    public TipoRequisito findTipoRequisito(Integer id) {
        EntityManager em = getEntityManager();
        try {
