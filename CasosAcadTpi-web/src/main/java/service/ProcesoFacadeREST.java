 ...
 */
@Stateless
@Path("uesocc.tpi.lib.proceso")
public class ProcesoFacadeREST extends AbstractFacade<Proceso> {

    @PersistenceContext(unitName = "PU")
    private EntityManager em;

    private ProcesoPK getPrimaryKey(PathSegment pathSegment) {
        /*
         * pathSemgent represents a URI path segment and any associated matrix parameters.
         * URI path part is supposed to be in form of 'somePath;idProceso=idProcesoValue;idCaso=idCasoValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        uesocc.tpi.lib.ProcesoPK key = new uesocc.tpi.lib.ProcesoPK();
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") PathSegment id, Proceso entity) {
        super.edit(entity);
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        uesocc.tpi.lib.ProcesoPK key = getPrimaryKey(id);
    ...
    public Proceso find(@PathParam("id") PathSegment id) {
        uesocc.tpi.lib.ProcesoPK key = getPrimaryKey(id);
