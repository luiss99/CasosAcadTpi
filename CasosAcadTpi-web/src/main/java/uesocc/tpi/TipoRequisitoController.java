...
public class TipoRequisitoController implements Serializable {
    ...
    @EJB
    private uesocc.tpi.TipoRequisitoFacade ejbFacade;
    ...
    private TipoRequisitoFacade getFacade() {
        return ejbFacade;
    }
    ...
    public TipoRequisito getTipoRequisito(java.lang.Integer id) {
    ...
    public static class TipoRequisitoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getTipoRequisito(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoRequisito) {
                ...
                return getStringKey(o.getIdTipoRequisito());
            } else {
